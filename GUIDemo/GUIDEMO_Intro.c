...
void GUIDEMO_Intro(void) {
  ...
  GUI_DispStringHCenterAt("奋斗版STM32研究平台", xCenter, (FACTOR_ANY_COMP * ySize) >> SCREEN_DIV);
  //GUI_DispStringHCenterAt("Any CPU - Any Display - Any Application", xCenter, (FACTOR_ANY_COMP * ySize) >> SCREEN_DIV);
  //
  // Compiled
  //
  GUI_SetFont(&GUI_Font10S_ASCII);
  GUI_DispStringHCenterAt("Compiled " __DATE__ " "__TIME__,          xCenter, ((FACTOR_ANY_COMP * ySize) >> SCREEN_DIV) + 33);
  //
  // Version
  //
  GUI_SetColor(GUI_WHITE);
  ...
  GUI_DispStringHCenterAt(acVersion, xCenter,  ((FACTOR_VERSION * ySize) >> SCREEN_DIV)+6);
  //
  // Logo
  //
  ...
  GUI_SetColor(GUI_WHITE);
  GUI_SetFont(&GUI_FontRounded22);
  GUI_DispStringHCenterAt("www.ourstm.net", xCenter, (FACTOR_WWW * ySize) >> SCREEN_DIV);
  GUIDEMO_Delay(5000);
}
